...
function Header() {
  return (
    <div className={`flex flex-col max-w-[1280px] m-auto items-center pt-[4rem] lg:flex-row lg:items-center lg:justify-between`}>
      <div className={`text-ligthbrown font-pacifico text-[2.5rem] sm:text-6xl md:text-7xl lg:text-6xl lg:justify-around lg:pl-[6rem]`}>
        {"< Hello, I'm Thiago />"}
      </div>
      <div
        className={`flex gap-8 w-[33rem] h-[10rem] justify-center mt-[4rem] rounded-3xl 
          ...
          sm:w-[50rem] md:w-[60rem] lg:w-[40rem] lg:mt-0 lg:w-[55rem] lg:gap-2 lg:mr-[6rem]`}
      >
